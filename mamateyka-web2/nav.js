document.addEventListener("DOMContentLoaded", () => {
  ...
  const setupCommunitySwitcher = () => {
    ...
    const data = {
      oratko: {
        ...
        image:
          "https://mamateyka.sk/wp-content/uploads/2025/09/2025_9_7-Otvorenie-oratka-12.jpg",
      ...
      mladi: {
        ...
        image:
          "https://mamateyka.sk/wp-content/uploads/2026/05/Mladym-pravdu.jpg",
      ...
      rodiny: {
        ...
        image:
          "https://mamateyka.sk/wp-content/uploads/2025/05/DEN-FARNOSTI-18.5.2025-113.jpg",
      ...
      farnost: {
        ...
        image:
          "https://mamateyka.sk/wp-content/uploads/2020/05/00_Kaplnka_slide.jpg",
  ...
  const setupSectionSpy = () => {
    const navGroups = Array.from(document.querySelectorAll("[data-section-spy]"));
    ...
    navGroups.forEach((group) => {
      ...
      const setCurrent = (link) => {
        links.forEach((node) => node.classList.remove("is-current"));
      ...
      const observer = new IntersectionObserver(
        (entries) => {
          ...
          const active = items.find((item) => item.target === visible[0].target);
